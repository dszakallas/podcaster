...
3. **Run Podcast Generation Workflow**
   - Execute the fully automated workflow in the **background** (set `is_background: true` when calling `run_shell_command`) to prevent timeouts, as the process takes ~10-20 minutes.
